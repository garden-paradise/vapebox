...
import './PersonalPolicy.scss';
import ArrowTitle from '../../../reuse_Components/ArrowTitle/ArrowTitle';

const PersonalPolicy = () => {
  let myCompany = 'ООО "Спорт-Персонал';
  let mySite = 'https://sport-personal.ru';
  let mySiteUrl = 'https://sport-personal.ru/personal_policy';
  let myEmail = 'sportpersonal@yandex.ru';

  return (
    <section className='Container PageBottom200 personalPolicy'>
      {window.innerWidth < 480 && <ArrowTitle title='Главная' link='' />}

      <Title title=' Согласие на обработку персональных данных' />

      <section className='personalPolicy-footer_argo'>
        <h4>
        ...
        <div>
          ...
          <div>
            ...
            {myCompany}" (далее – Оператор).
          </div>
          <div className='personalPolicy-subtitle'>
            <div>
            ...
            <div>
              ...
              веб-сайта &#160; <a href={`${mySite}`}>{mySite}</a>.
            </div>
          </div>
        </div>
        <div>
        ...
        <div>
          <div>
            ...
            <div className='personalPolicy-subtitle'>
              ...
              <div>5.2. Номер телефона;</div>
              <div>5.3. Адрес электронной почты;</div>
              <div>
          ...
          <div>
            ...
            <div className='personalPolicy-subtitle'>
              ...
              <div>
                ...
                <div>– уточнение деталей заказа.</div>
              </div>
              <div>
                ...
                <a href=''>{myEmail}</a> с пометкой «Отказ от уведомлений о
              ...
              <div>
                <div>
                  ...
                  <i>
                    ...
                    ваша деятельность связана с информационными технологиями, в
                    частности с созданием сайтов, то здесь можно указать
                    Федеральный закон "Об информации, информационных технологиях
                    и о защите информации" от 27.07.2006 N 149-ФЗ
                  </i>
                  ;
                </div>
                <div>– уставные документы Оператора;</div>
                <div>
          ...
          <div>
            ...
            <div className='personalPolicy-subtitle'>
              ...
              <div>
                ...
                Оператора &#160; <a href=''>{myEmail}</a> с пометкой
              ...
              <div>
                ...
                электронный адрес Оператора &#160; <a href=''>{myEmail}</a> с
